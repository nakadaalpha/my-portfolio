...
const Contact = () => {
  return (
    <section id="contact" className="pt-24 pb-8 bg-slate-50 border-t border-slate-200 relative overflow-hidden">
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] rounded-full blur-[100px] pointer-events-none bg-red-500/5"></div>
      ...
      <div className="max-w-4xl mx-auto px-6 sm:px-10 relative z-10 text-center">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
          ...
          <a
            ...
            className="group relative inline-flex items-center justify-center px-8 py-4 bg-white text-slate-800 font-medium rounded-xl border border-slate-200 shadow-sm hover:shadow-md hover:border-red-500/50 hover:text-red-600 transition-all duration-300 overflow-hidden w-full sm:w-auto"
          >
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="group relative inline-flex items-center justify-center px-8 py-4 bg-white text-slate-800 font-medium rounded-xl border border-slate-200 shadow-sm hover:shadow-md hover:border-blue-500/50 hover:text-blue-600 transition-all duration-300 overflow-hidden w-full sm:w-auto"
          >
            <span className="relative z-10 flex items-center gap-3">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="group relative inline-flex items-center justify-center px-8 py-4 bg-white text-slate-800 font-medium rounded-xl border border-slate-200 shadow-sm hover:shadow-md hover:border-emerald-500/50 hover:text-emerald-600 transition-all duration-300 overflow-hidden w-full sm:w-auto"
          >
            <span className="relative z-10 flex items-center gap-3">
